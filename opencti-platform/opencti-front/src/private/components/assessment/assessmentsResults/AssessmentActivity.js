...
class AssessmentActivityComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      displayEdit: false,
...
AssessmentActivityComponent.propTypes = {
...
const Assessment = createFragmentContainer(AssessmentActivityComponent, {
  assessment: graphql`
    fragment AssessmentActivity_data on Risk {
      __typename
      id
      created
      modified
