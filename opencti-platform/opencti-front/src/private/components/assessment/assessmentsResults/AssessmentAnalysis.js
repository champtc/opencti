...
class AssessmentAnalysisComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      displayEdit: false,
...
AssessmentAnalysisComponent.propTypes = {
...
const Assessment = createFragmentContainer(AssessmentAnalysisComponent, {
  assessment: graphql`
    fragment AssessmentAnalysis_data on Risk {
      __typename
      id
      created
      modified
