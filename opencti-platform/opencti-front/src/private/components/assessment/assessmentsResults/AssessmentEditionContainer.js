...
const assessmentEditionContainerMutation = graphql`
  mutation AssessmentEditionContainerMutation(
    $id: ID!,
    $input: [EditInput]!
  ) {
...
class AssessmentEditionContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
...
AssessmentEditionContainer.propTypes = {
