...
class AssessmentsCardComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      openMenu: false,
...
AssessmentsCardComponent.propTypes = {
...
const AssessmentsCardFragment = createFragmentContainer(
  AssessmentsCardComponent,
  {
    node: graphql`
      fragment AssessmentsCard_node on Risk {
        id
        poam_id
        name
        risk_level
...
export const AssessmentsCard = compose(
  inject18n,
  withStyles(styles),
)(AssessmentsCardFragment);

class AssessmentsCardDummyComponent extends Component {
  render() {
...
AssessmentsCardDummyComponent.propTypes = {
  classes: PropTypes.object,
};

export const AssessmentsCardDummy = compose(
  inject18n,
  withStyles(styles),
)(AssessmentsCardDummyComponent);
