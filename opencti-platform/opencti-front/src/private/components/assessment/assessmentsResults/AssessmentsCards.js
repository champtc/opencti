...
class AssessmentsCards extends Component {
  constructor(props) {
    super(props);
...
export const assessmentsCardsQuery = graphql`
  query AssessmentsCardsPaginationQuery(
    $search: String
    $first: Int!
    $offset: Int!
    $cursor: ID
...
export default createPaginationContainer(
  ...
  {
    data: graphql`
      fragment AssessmentsCards_data on Query
      @argumentDefinitions(
        search: { type: "String" }
