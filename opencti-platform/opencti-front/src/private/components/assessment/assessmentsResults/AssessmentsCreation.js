...
const assessmentsCreationMutation = graphql`
  mutation AssessmentsCreationMutation($input: OscalTaskAddInput) {
...
class AssessmentsCreation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  onSubmit(values, { setSubmitting, resetForm }) {
    ...
    commitMutation({
      mutation: assessmentsCreationMutation,
      variables: {
        input: finalValues,
      },
      setSubmitting,
