...
class AssessmentsLines extends Component {
  constructor(props) {
    super(props);
    this.state = { offset: 0 };
  }
...
export const assessmentsLinesQuery = graphql`
  query AssessmentsLinesPaginationQuery(
    $search: String
    $first: Int!
    $offset: Int!
    $cursor: ID
...
export default createPaginationContainer(
  ...
  {
    data: graphql`
      fragment AssessmentsLines_data on Query
      @argumentDefinitions(
        search: { type: "String" }
