...
import { EntityDataMarkingLine, EntityDataMarkingLineDummy } from './EntityDataMarkingLine';

const nbOfRowsToLoad = 50;

class EntitiesDataMarkingsLines extends Component {
  constructor(props) {
    super(props);
    this.state = { offset: 0 };
  }
  ...
  render() {
    ...
    return (
      <ListLinesContent
        ...
        offset={this.state.offset}
        LineComponent={<EntityDataMarkingLine history={history} />}
        DummyLineComponent={<EntityDataMarkingLineDummy />}
        selectAll={selectAll}
...
EntitiesDataMarkingsLines.propTypes = {
...
export const entitiesDataMarkingsLinesQuery = graphql`
  query EntitiesDataMarkingsLinesPaginationQuery(
    $search: String
    $first: Int!
    $offset: Int!
    $cursor: ID
    ...
    ...EntitiesDataMarkingsLines_data
      @arguments(
        search: $search
        first: $first
        offset: $offset
...
export default createPaginationContainer(
  ...
  {
    data: graphql`
      fragment EntitiesDataMarkingsLines_data on Query
      @argumentDefinitions(
        search: { type: "String" }
