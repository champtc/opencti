...
class EntityDataMarkingStatementDetails extends Component {
  render() {
          ...
          <Grid container={true}>
            ...
            <Grid item xs={6}>
              <div>
                ...
                <div className={classes.tooltip}>
                  <Tooltip title={t('Statement Text')}>
                    <Information fontSize='inherit' color='disabled' />
                  </Tooltip>
                </div>
                <div className='clearfix' />
                {dataMarking?.statement && t(dataMarking.statement)}
              </div>
            </Grid>
          </Grid>
        </Paper>
...
EntityDataMarkingStatementDetails.propTypes = {
