...
const entitiesInformationTypesCreationMutation = graphql`
  mutation EntitiesInformationTypesCreationMutation(
...
class EntitiesInformationTypesCreation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedProduct: {},
...
EntitiesInformationTypesCreation.propTypes = {
  t: PropTypes.func,
...
export default compose(inject18n, withStyles(styles))(EntitiesInformationTypesCreation);
