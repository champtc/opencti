...
class EntitiesInformationTypesPopover extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
...
EntitiesInformationTypesPopover.propTypes = {
...
export default compose(inject18n, withStyles(styles))(EntitiesInformationTypesPopover);
