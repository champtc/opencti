...
class EntityInformationTypeLineComponent extends Component {
  render() {
    const {
      t,
      fd,
...
EntityInformationTypeLineComponent.propTypes = {
...
const EntityInformationTypeLineFragment = createFragmentContainer(
  EntityInformationTypeLineComponent,
  {
    node: graphql`
      fragment EntityInformationTypeLine_node on InformationType {
        __typename
        id
        title
        created
...
export const EntityInformationTypeLine = compose(
  inject18n,
  withStyles(styles),
)(EntityInformationTypeLineFragment);

class EntityInformationTypeLineDummyComponent extends Component {
  render() {
...
EntityInformationTypeLineDummyComponent.propTypes = {
  classes: PropTypes.object,
  dataColumns: PropTypes.object,
};

export const EntityInformationTypeLineDummy = compose(
  inject18n,
  withStyles(styles),
)(EntityInformationTypeLineDummyComponent);
