...
class EntityInformationTypeOverviewComponent extends Component {
  render() {
    const {
      t,
      classes,
            ...
            <Grid container spacing={1}>
              <Grid item xs={12}>
                <div>
                  ...
                  {informationType.id && t(informationType.id)}
                </div>
              </Grid>
              <Grid item xs={6}>
              ...
              <Grid item xs={6}>
                <div style={{ marginTop: '20px' }}>
                  ...
                  <div className="clearfix" />
                  {informationType.modified
                    && fldt(informationType.modified)}
                </div>
              </Grid>
...
EntityInformationTypeOverviewComponent.propTypes = {
...
const EntityInformationTypeOverview = createFragmentContainer(
  EntityInformationTypeOverviewComponent,
  {
    informationType: graphql`
      fragment EntityInformationTypeOverview_informationType on InformationType {
        __typename
        id
        created
        modified
...
export default compose(inject18n, withStyles(styles))(EntityInformationTypeOverview);
