...
const entitiesLeveragedAuthorizationsDeletionDarkLightMutation = graphql`
  mutation EntitiesLeveragedAuthorizationsDeletionDarkLightMutation($id: ID!) {
  deleteLeveragedAuthorization(id: $id)
}
`;

class EntitiesLeveragedAuthorizationsDeletion extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
  ...
  submitDelete() {
    ...
    commitMutation({
      mutation: entitiesLeveragedAuthorizationsDeletionDarkLightMutation,
      variables: {
...
EntitiesLeveragedAuthorizationsDeletion.propTypes = {
  id: PropTypes.array,
...
export default compose(
  ...
  withRouter,
  withStyles(styles),
)(EntitiesLeveragedAuthorizationsDeletion);
