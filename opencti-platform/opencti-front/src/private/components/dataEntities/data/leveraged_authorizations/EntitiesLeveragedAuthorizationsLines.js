...
import { EntityLeveragedAuthorizationLine, EntityLeveragedAuthorizationLineDummy } from './EntityLeveragedAuthorizationLine';
import { setNumberOfElements } from '../../../../../utils/Number';

const nbOfRowsToLoad = 50;

class EntitiesLeveragedAuthorizationsLines extends Component {
  constructor(props) {
    super(props);
    this.state = { offset: 0 };
  }
  ...
  render() {
    ...
    return (
      <ListLinesContent
        ...
        offset={this.state.offset}
        LineComponent={<EntityLeveragedAuthorizationLine history={history} />}
        DummyLineComponent={<EntityLeveragedAuthorizationLineDummy />}
        selectAll={selectAll}
...
EntitiesLeveragedAuthorizationsLines.propTypes = {
...
export const entitiesLeveragedAuthorizationsLinesQuery = graphql`
  query EntitiesLeveragedAuthorizationsLinesPaginationQuery(
    $search: String
    $first: Int!
    $offset: Int!
    $cursor: ID
    ...
    ...EntitiesLeveragedAuthorizationsLines_data
      @arguments(
        search: $search
        first: $first
        offset: $offset
...
export default createPaginationContainer(
  ...
  {
    data: graphql`
      fragment EntitiesLeveragedAuthorizationsLines_data on Query
      @argumentDefinitions(
        search: { type: "String" }
        ...
        leveragedAuthorizations(
          ...
          edges {
            node {
              id
              title
              ...EntityLeveragedAuthorizationLine_node
            }
          }
          pageInfo {
            endCursor
