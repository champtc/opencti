...
class EntitiesLeveragedAuthorizationsPopover extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
...
EntitiesLeveragedAuthorizationsPopover.propTypes = {
...
export default compose(inject18n, withStyles(styles))(EntitiesLeveragedAuthorizationsPopover);
