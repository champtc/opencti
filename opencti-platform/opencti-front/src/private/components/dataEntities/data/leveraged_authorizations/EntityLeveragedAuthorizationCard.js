...
class EntityLeveragedAuthorizationCardComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      openMenu: false,
...
EntityLeveragedAuthorizationCardComponent.propTypes = {
...
const EntityLeveragedAuthorizationCardFragment = createFragmentContainer(
  EntityLeveragedAuthorizationCardComponent,
  {
    node: graphql`
      fragment EntityLeveragedAuthorizationCard_node on OscalLeveragedAuthorization {
        __typename
        id
        date_authorized
        title
...
export const EntityLeveragedAuthorizationCard = compose(
  inject18n,
  withStyles(styles),
)(EntityLeveragedAuthorizationCardFragment);

class EntityLeveragedAuthorizationCardDummyComponent extends Component {
  render() {
...
EntityLeveragedAuthorizationCardDummyComponent.propTypes = {
  classes: PropTypes.object,
};

export const EntityLeveragedAuthorizationCardDummy = compose(
  inject18n,
  withStyles(styles),
)(EntityLeveragedAuthorizationCardDummyComponent);
