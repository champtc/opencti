...
const leveragedAuthorizationEntityEditionQuery = graphql`
  query LeveragedAuthorizationEntityEditionQuery($id: ID!) {
...
class LeveragedAuthorizationEntityEdition extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
  ...
  render() {
    const {
      classes, displayEdit, handleDisplayEdit, history, leveragedAuthorizationId,
    } = this.props;
    return (
      <div className={classes.container}>
        <QueryRenderer
          query={leveragedAuthorizationEntityEditionQuery}
...
LeveragedAuthorizationEntityEdition.propTypes = {
