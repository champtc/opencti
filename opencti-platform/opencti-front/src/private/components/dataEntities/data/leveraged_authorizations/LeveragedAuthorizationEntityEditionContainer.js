...
const leveragedAuthorizationEntityEditionContainerMutation = graphql`
...
class LeveragedAuthorizationEntityEditionContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
...
LeveragedAuthorizationEntityEditionContainer.propTypes = {
