...
class EntitiesResponsiblePartiesPopover extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
...
EntitiesResponsiblePartiesPopover.propTypes = {
...
export default compose(inject18n, withStyles(styles))(EntitiesResponsiblePartiesPopover);
