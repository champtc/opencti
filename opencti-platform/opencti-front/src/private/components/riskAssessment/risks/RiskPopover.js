...
const RiskPopoverDeletionMutation = graphql`
  mutation RiskPopoverDeletionMutation($id: ID!) {
...
class RiskPopover extends Component {
  ...
  submitDelete() {
    ...
    commitMutation({
      mutation: RiskPopoverDeletionMutation,
      variables: {
        id: this.props.id,
      },
      config: [
    ...
    return (
      <div className={classes.container}>
        ...
        >
          <DialogContent>
            <DialogContentText>
              {t('Do you want to delete this risk?')}
            </DialogContentText>
          </DialogContent>
          <DialogActions>
            <Button
