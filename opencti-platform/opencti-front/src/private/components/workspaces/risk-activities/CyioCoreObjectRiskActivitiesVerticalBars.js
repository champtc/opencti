...
class CyioCoreObjectRiskActivitiesVerticalBars extends Component {
  renderContent() {
    const {
      t,
      md,
...
CyioCoreObjectRiskActivitiesVerticalBars.propTypes = {
...
export default compose(
  ...
  withTheme,
  withStyles(styles),
)(CyioCoreObjectRiskActivitiesVerticalBars);
