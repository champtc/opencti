...
const cyioCoreObjectTotalComponentsAreaChartQuery = graphql`
  query CyioCoreObjectTotalComponentsAreaChartQuery(
    $type: String
    $field: String!
    $match: [String]
...
class CyioCoreObjectTotalComponentsAreaChart extends Component {
  renderContent() {
    const {
      t,
      md,
...
CyioCoreObjectTotalComponentsAreaChart.propTypes = {
...
export default compose(
  ...
  withTheme,
  withStyles(styles),
)(CyioCoreObjectTotalComponentsAreaChart);
