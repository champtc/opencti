...
class CyioCoreObjectVulnerableComponentVerticalBars extends Component {
  renderContent() {
    const {
      t,
      md,
...
CyioCoreObjectVulnerableComponentVerticalBars.propTypes = {
...
export default compose(
  ...
  withTheme,
  withStyles(styles),
)(CyioCoreObjectVulnerableComponentVerticalBars);
