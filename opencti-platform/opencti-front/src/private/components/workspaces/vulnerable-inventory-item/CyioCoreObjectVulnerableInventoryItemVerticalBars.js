...
class CyioCoreObjectVulnerableInventoryItemVerticalBars extends Component {
  renderContent() {
    const {
      t,
      md,
    ...
    return (
      <div style={{ height: height || '100%' }}>
        <Typography variant="h4" gutterBottom={true}>
          {title || t('Vulnerable Inventory Item')}
        </Typography>
        {variant !== 'inLine' ? (
...
CyioCoreObjectVulnerableInventoryItemVerticalBars.propTypes = {
...
export default compose(
  ...
  withTheme,
  withStyles(styles),
)(CyioCoreObjectVulnerableInventoryItemVerticalBars);
