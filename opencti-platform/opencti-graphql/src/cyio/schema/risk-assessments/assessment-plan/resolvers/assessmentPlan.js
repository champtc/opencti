...
// Revisions
import { findRevisionsByIri } from '../../oscal-common/domain/oscalRevisions.js';
...
const cyioAssessmentPlanResolvers = {
  ...
  AssessmentPlan: {
    revisions: async (parent, _, { dbName, dataSources, selectMap }) => {
      // if (parent.revision_iris === undefined) return [];
      // let results = []
      // for (let iri of parent.revision_iris) {
    ...
    document_ids: async (parent, _, { dbName, dataSources, selectMap }) => {
      // if (parent.document_id_iris === undefined) return [];
      // let results = []
    ...
    system_security_plan: async (parent, _, { dbName, dataSources, selectMap }) => {
      // if (parent.system_security_plan_iris === undefined) return [];
      // let results = []
      // for (let iri of parent.system_security_plan_iris) {
    ...
    assessment_subjects: async (parent, _, { dbName, dataSources, selectMap }) => {
      // if (parent.assessment_subject_iris === undefined) return [];
      // let results = []
      // for (let iri of parent.assessment_subject_iris) {
    ...
    assessment_assets: async (parent, _, { dbName, dataSources, selectMap }) => {
      // if (parent.assessment_asset_iris === undefined) return [];
      // let results = []
      // for (let iri of parent.assessment_asset_iris) {
    ...
    resources: async (parent, _, { dbName, dataSources, selectMap }) => {
      // if (parent.resource_iris === undefined) return [];
      // let results = []
      // for (let iri of parent.resource_iris) {
