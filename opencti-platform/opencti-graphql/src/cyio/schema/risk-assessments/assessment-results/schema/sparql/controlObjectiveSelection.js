...
const controlObjectiveSelectionReducer = (item) => {
  ...
  return {
    ...
    ...(item.include_all_objectives !== undefined && { include_all_objectives: item.include_all_objectives }),
...
export const selectControlObjectiveSelectionQuery = (id, select) => {
  return selectControlObjectiveSelectionByIriQuery(getControlObjectiveSelectionIri(id), select);
}
...
export const insertControlObjectiveSelectionQuery = (propValues) => {
  ...
  const iri = getControlObjectiveSelectionIri(id);
...
export const controlObjectiveSelectionPredicateMap = {
  ...
  include_all_objectives: {
    ...
    binding: function (iri, value) { return parameterizePredicate(iri, value !== undefined ? `"${value}"^^xsd:boolean` : null, this.predicate, "include_all_objectives");},
    optional: function (iri, value) { return optionalizePredicate(this.binding(iri, value));},
  },
  include_objectives: {
